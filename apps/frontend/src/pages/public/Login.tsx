  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      ...
      <div className="flex gap-3">
        <Button
          variant="outline"
          className="flex-1 gap-3 rounded-none border-foreground/20 hover:border-primary/40 hover:bg-primary/5 font-mono text-[10px] font-black tracking-widest uppercase text-foreground h-12"
