  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="text-center">
        ...
        <h1 className="mt-3 text-3xl font-display font-semibold">Verification du nouvel email</h1>
          ...
          {status === 'success' && (
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold">Nouvel email confirme</p>
                  <p className="text-xs text-muted-foreground">
                    Votre adresse principale a ete mise a jour avec succes.
                  </p>
                </div>
              </div>
